/* 
  ...
  This file is to implement the Stack ADT by using a Deque for 
  underlying data structure. It’s designed for the Stack ADT 
  using deque to do some operations with the generic type.
*/
